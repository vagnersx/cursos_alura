...
INSERT INTO usuarios (
    ...
    email,
    senha
) SELECT 'Vagner Xavier', 'vagner.xavier@serpro.gov.br', '123' WHERE NOT EXISTS (SELECT * FROM usuarios WHERE email = 'gabriel@alura.com.br')
`;
...
INSERT INTO livros (
    ...
    preco,
    descricao
) SELECT 'Node2 na prática', 30.0, 'Como desenvolver com Node.' WHERE NOT EXISTS (SELECT * FROM livros WHERE titulo = 'Node na prática')
`;
